...
export const copy = {
  en: {
    ...
    hero: {
      eyebrow: "MOVEMENT • CODE • DESIGN",
      title: "RAWLAB_",
      description:
        "A living digital archive where technology, movement, visual systems and human experience coexist.",
      explore: "Explore",
      github: "GitHub",
    },
    visualArchive: {
  ...
  es: {
    ...
    hero: {
      eyebrow: "MOVIMIENTO • CÓDIGO • DISEÑO",
      title: "RAWLAB_",
      description:
